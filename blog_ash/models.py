...
class Sidebar(models.Model):
    ...
    def get_content(self):
        if self.display_type == 1:
            ...
            return render_to_string('blog_ash/sidebar/search.html', context=context)
        elif self.display_type == 2:
            context = {
                
            }
            return render_to_string('blog_ash/sidebar/new_post.html', context=context)
        elif self.display_type == 3:
            context = {

            }
            return render_to_string('blog_ash/sidebar/hot_post.html', context=context)
        elif self.display_type == 4:  
            context = {

            }
            return render_to_string('blog_ash/sidebar/commment.html', context=context)
        elif self.display_type == 5:   # 文章归档
            context = {

            }
            return render_to_string('blog_ash/sidebar/archives.html', context=context)
